...
/ - это означает, что выполняется какая-то команда, после имени команды, через пробел, можно вводить аргументы""",
        ...
        'timer': '/timer - раздел таймеров можно выбрать уже существующий, создать (/add_timer), редактировать (/edit_t'
                 'imer) и удалять свой таймер (/delete_timer), ставить свой таймер (/set_timer)',
...
MARKUPS = {'base': [['/help', '/timer']],
           'timer': [['/help timer', '/set_timer', '/add_timer'], ['/edit_timer', '/delete_timer', '/back']]
           }
